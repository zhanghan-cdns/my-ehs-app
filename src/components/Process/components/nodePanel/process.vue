...
export default {
        ...
        item: [
          {
            ...
            dic: { data: _this.categorys, label: 'dictValueName', value: 'dictValue' }
          },
          {
            xType: 'input',
            name: 'id',
  ...
  methods: {
    computedSignalLength() {
      ...
      this.signalLength = this.element.businessObject.extensionElements&&this.element.businessObject.extensionElements.values?this.element.businessObject.extensionElements.values.length : 0
    },
    finishSignal() {
