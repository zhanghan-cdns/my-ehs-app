...
export default {
  ...
  mounted() {
    this.formData.executionListener = this.element.businessObject.extensionElements&&this.element.businessObject.extensionElements.values
      ...
      .map(item => {
        ...
        return {
          ...
          type: type,
          className: item[type],
          params: item&&item.fields.map(field => {
            let fieldType
  ...
  methods: {
    ...
    updateElement() {
      if (this.formData.executionListener&&this.formData.executionListener.length) {
        ...
        extensionElements.values = extensionElements.values&&extensionElements.values.filter(item => item.$type !== 'flowable:ExecutionListener') || []
