...
export default {
  ...
  mounted() {
    this.formData.taskListener =this.element.businessObject.extensionElements&& this.element.businessObject.extensionElements.values
      ...
      .map(item => {
        ...
        return {
          ...
          type: type,
          className: item[type],
          params:item.fields&& item.fields.map(field => {
            let fieldType
  ...
  methods: {
    ...
    updateElement() {
      if (this.formData.taskListener&&this.formData.taskListener.length) {
        ...
        extensionElements.values = extensionElements.values&&extensionElements.values.filter(item => item.$type !== 'flowable:TaskListener') || []
