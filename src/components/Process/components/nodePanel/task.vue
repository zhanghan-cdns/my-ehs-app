...
export default {
  ...
  watch: {
    ...
    'formData.candidateUsers': function(val) {
        ...
        this.updateProperties({'flowable:candidateUsers': val&&val.join(',')})
    },
    'formData.candidateGroups': function(val) {
        ...
        this.updateProperties({'flowable:candidateGroups': val&&val.join(',')})
    },
  ...
  methods: {
    computedExecutionListenerLength() {
      ...
      this.executionListenerLength = this.element.businessObject.extensionElements&&this.element.businessObject.extensionElements.values&&
        this.element.businessObject.extensionElements.values.filter(item => item.$type === 'flowable:ExecutionListener').length || 0
    },
    computedTaskListenerLength() {
      ...
      this.taskListenerLength = this.element.businessObject.extensionElements&&this.element.businessObject.extensionElements.values&&
        this.element.businessObject.extensionElements.values.filter(item => item.$type === 'flowable:TaskListener').length || 0
    },
