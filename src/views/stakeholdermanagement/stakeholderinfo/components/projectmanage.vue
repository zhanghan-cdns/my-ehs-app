    ...
    <list-container>
      ...
      <template #right>
        <div class="role_operation_box">
          ...
          <header-button @headerButtonClick="headerButtonMethods" :headerButtonList="['chaxun']" />
        </div>
        <render-table :height="height" :data="tableData" :columns="columns" />
        <basicPager :page="page" @pageChange="pageChange"></basicPager>
      </template>
    </list-container>
    <add-projectmanage ref="addProjectmanageRef"></add-projectmanage>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    operateButtonClick(type, row) {
      switch (type) {
        case "chakan":
          this.$refs.addProjectmanageRef.open(row, "chakan");
          break;
      }
    },
  },
