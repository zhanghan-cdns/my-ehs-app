<template>
  <div>
    ...
    <add-constructionTeam ref="addConstructionTeamRef" :dict="{ commonJudge }"></add-constructionTeam>
  </div>
</template>
<script>
import addConstructionTeam from "./addConstructionTeam";
import dict from "@/mixins/dict";
export default {
  mixins: [dict],
  name: "constructionTeam",
  components: { addConstructionTeam },
