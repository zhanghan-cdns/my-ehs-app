    ...
    >
      <template #content>
        ...
        >
          <el-row>
            <el-col span="24">
              <el-form-item label="风险分析对象" prop="riskAnalysisUnitId">
                <el-select
          ...
          <el-row>
            <el-col span="24">
              <el-form-item label="风险事件" prop="riskAnalysisUnitId">
                <el-select
                  placeholder="请选择风险事件"
                  clearable
                  v-model="form.riskAnalysisUnitId"
          ...
          <el-row>
            <el-col span="24">
              <el-form-item label="管控方式" prop="riskAnalysisUnitId">
                <el-select
                  placeholder="请选择管控方式"
                  clearable
                  v-model="form.riskAnalysisUnitId"
...
export default {
  ...
  data() {
    return {
      ...
      operateButtonList: ["tianjiabanci", "bianji", "shanchu"],
