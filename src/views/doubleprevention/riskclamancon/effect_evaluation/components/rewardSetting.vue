      ...
      <template #content>
        <div class="content">
          ...
          >
            <el-row>
              <el-col span="12">
                <el-form-item label="被奖励人" prop="correctTheTitle">
                  <el-input
                    style="width: 240px"
                    clearable
              ...
              <el-col span="12">
                <el-form-item label="奖励金额（元）" prop="correctionOrderNumber">
                  <el-input
                    style="width: 240px"
                    clearable
                    disabled
            ...
            <el-row>
              <el-col span="24">
                <el-form-item label="奖励内容" prop="rectificationOpinion">
                  <el-input
                    style="width: 660px"
                    clearable
                    type="textarea"
            ...
            <el-row>
              <el-col span="24">
                <el-form-item label="奖励依据" prop="causeAnalysis">
                  <el-input
                    style="width: 660px"
                    clearable
                    type="textarea"
