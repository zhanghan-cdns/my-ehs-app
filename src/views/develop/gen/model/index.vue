      ...
      <template #right>
        <div class="role_operation_box">
          <div style="display:flex">
            <el-input v-model="query.modelName" placeholder="请输入模型名称"></el-input>
          </div>
...
import { modelListAPI, modelBatchRemoveAPI } from "@/api/develop/gen/model/model";
  ...
  methods: {
    ...
    deleteTable(id) {
      this.$confirm("你确定要删除此条记录吗?", "提示", {
        ...
        modelBatchRemoveAPI({ ids: id }).then(res => {
