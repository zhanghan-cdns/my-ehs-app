<template>
  <div id="graph">
    ...
    <div class="content-right">
      <div class="content-title">储罐列表</div>
      <div class="graph-container">
        <div class="graph-title">储罐列表</div>
        <div class="graph-content">
          <div class="graph-content-tongji">
            <span class="tongji-attr">储罐点位数:</span>
              ...
              >
                <div class="graph-col-left">
                  <div class="col-left-top">
                    <img
                      class="col-left-img"
                      src="@/assets/images/realTimeData/chuguan.png"
                      alt=""
                    />
                  </div>
                ...
                <div class="graph-col-right">
                  <div class="col-right-item">
                    <span class="right-item-attr">储罐名称:</span>
...
import { storageTankGraphListAPI } from "@/api/hazard/realtimeData/index";
...
export default {
  ...
  methods: {
    ...
    // 储罐的图形数据
    async getStorageTankGraphList() {
      const res = await storageTankGraphListAPI({ room: this.id.join(",") });
