<template>
  <div id="graph">
    ...
    <div class="content-right">
      <div class="content-title">气体列表</div>
      <div class="graph-container">
        <div class="graph-title">气体列表</div>
        <div class="graph-content">
          <div class="graph-content-tongji">
            <span class="tongji-attr">气体点位数:</span>
              ...
              >
                <div class="graph-col-left">
                  <div class="col-left-top">
                    <img
                      class="col-left-img"
                      src="@/assets/images/realTimeData/qiti.png"
                      alt=""
                    />
                  </div>
                ...
                <div class="graph-col-right">
                  <div class="col-right-item">
                    <span class="right-item-attr">气体名称:</span>
...
import { gasGraphListAPI } from "@/api/hazard/realtimeData/index";
...
export default {
  ...
  methods: {
    ...
    // 气体的图形数据
    async getGasGraphList() {
      const res = await gasGraphListAPI({ room: this.id.join(",") });
      if (res && res.code === 200 && res.data) {
        this.gasList = res.data.data;
