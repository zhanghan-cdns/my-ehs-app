          ...
          <div class="container">
            ...
            ></el-autocomplete>
              ...
              <el-form-item label="证书名称" prop="certificateName" required>
                <el-input v-model="form.certificateName" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="证书编号" required>
                <el-input v-model="form.certificateNum" :disabled="true"></el-input>
              </el-form-item>
              ...
              <el-form-item label="证书描述">
                <el-input class="contentInput" v-model="form.certificateDescription" :disabled="true"></el-input>
              </el-form-item>
