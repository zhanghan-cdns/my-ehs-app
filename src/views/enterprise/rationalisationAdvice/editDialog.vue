      ...
      <template #content>
        ...
        >
          <el-row>
              ...
              <el-form-item label="正文" prop="editorValue">
                  <basic-editor ref="tinymceEditorRef" :value='form.editorValue' @getEditorValue="getEditorValue"></basic-editor>
                <!-- <el-input
                  type="textarea"
                  placeholder="请输入正文"
                  v-model="form.targetName"
              ...
              <!-- <div style="width:300px;height:100px;border:1px solid red;">{{form.editorValue}}</div> -->
...
export default {
  ...
  methods: {
    getEditorValue(e){
      console.log('e',e);
      this.$set(this.form,'editorValue',e);
    },
    // 打开
    open(row, type) {
      this.openEdit = true;
