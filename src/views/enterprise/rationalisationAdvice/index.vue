<template>
  <div>
    ...
    <view-dialog ref="viewDialogRef" :dictConfig="{}" @refresh="getTableData({})"></view-dialog>
    ...
    return {
      ...
      tableData: [
        { 
          id:1,
          safetyTarget: "1",
          safeDynamicTopic:'省应急管理厅关于做好台风期间安全防范工作的紧急通知',
          content:'123',
    ...
    operateButtonClick(type, row) {
      switch (type) {
        ...
        case "xiafa":
          break;
          case "shenpi":
            this.$refs.auditDialogRef.open(row,type);
            break;
      }
    },
    //点击主题
