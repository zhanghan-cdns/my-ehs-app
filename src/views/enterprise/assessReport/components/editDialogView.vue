          ...
          <div class="container">
            ...
            >
              <el-form-item
                ...
                class="is-required"
              >
                <el-input clearable v-model="form.evaluationReportName" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="评价报告编号" prop="evaluationReportNum">
                <el-input v-model="form.evaluationReportNum" :disabled="true"></el-input>
              </el-form-item>
              ...
              <el-form-item label="评价机构" prop="evaluationOrganization">
                <el-input v-model="form.evaluationOrganization" :disabled="true"></el-input>
              ...
              <el-row>
                <el-col>
                  <el-form-item label="报告附件">
                    <show-file :data="form.reportFile"></show-file>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col>
                  <el-form-item label="备案附件">
                    <show-file :data="form.relatedAccessories"></show-file>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
