          ...
          <div class="container">
            ...
            >
              ...
              <el-row>
                ...
                <el-image
                  v-for="item in form.photoUpload"
                  :key="item.url"
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="工卡绑定">
                    <el-input style="width: 100%" v-model="form.jobCardBind">
                      <el-button slot="append" icon="el-icon-search"  class="card" type="primary">绑卡</el-button>
                    </el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            ...
            <el-col>
              <el-form-item label="工作简历">
                <show-file :data="form.entPersonWorkResume"></show-file>
              </el-form-item>
            </el-col>
          </el-row>
               <el-row>
            <el-col>
              <el-form-item label="学历证书">
                <el-image
                  v-for="item in form.academicCertificate"
                  :key="item.url"
                  style="width: 100px; height: 100px"
                  :src="imgUrl+ item.url"
                  :preview-src-list="[imgUrl+item.url]"
          ...
          <el-row>
            <el-col>
              <el-form-item label="上传证书">
                <show-file :data="form.certificateUpload"></show-file>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col>
              <el-form-item label="上传附件">
                <show-file :data="form.enclosureUpload"></show-file>
              </el-form-item>
            </el-col>
          </el-row>
            </el-form>
