    ...
    >
      <template #content>
        <el-form label-width="140px" label-position="right" :model="form" :rules="rules" ref="formRef">
          ...
          <el-row>
            ...
            <el-col span="12">
              <el-form-item label="CAS号">
                <el-input placeholder="CAS号" clearable v-model="form.casNumber" :style="`width:${width}`"
                          :size="size"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col span="12">
              <el-form-item label="危险化学品目录序号">
                <el-input placeholder="危险化学品目录序号" clearable v-model="form.catalogueNo" :style="`width:${width}`"
                          :size="size"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col span="12">
              <el-form-item label="年消耗量（吨）" prop="annualConsumption">
                <el-input-number placeholder="年消耗量（吨）" clearable v-model="form.annualConsumption"
                                 :style="`width:${width}`"
            ...
            <el-col span="12">
              <el-form-item label="最大储量（吨）">
                <el-input-number placeholder="最大储量（吨）" v-model.number="form.maxStorageCapacity"
                                 :style="`width:${width}`"
                                 :size="size"></el-input-number>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col span="12">
              <el-form-item label="实际储量（吨）" prop="actualReserves">
                <el-input-number placeholder="实际储量（吨）" clearable v-model.number="form.actualReserves"
                                 :style="`width:${width}`"
                                 :size="size"></el-input-number>
              </el-form-item>
            </el-col>
            <el-col span="12">
              <el-form-item label="单位">
                <el-select placeholder="单位" clearable v-model="form.measureUnit" :style="`width:${width}`"
                           :size="size">
                  <el-option v-for="item in dictConfig.entMeasureUnit" :key="item.id" :value="item.dictValue"
                             :label="item.dictValueName"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col span="12">
              <el-form-item label="储存位置" prop="storageLocation">
                <el-input placeholder="储存位置" clearable v-model="form.storageLocation" :style="`width:${width}`"
                          :size="size"></el-input>
              </el-form-item>
            </el-col>
            <el-col span="12">
          ...
          <el-row>
            <el-col>
              <el-form-item label="应急处理措施" prop="emergencyMeasures">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        //应急处理措施
        emergencyMeasures: [
          {required: true, message: "请输入应急处理措施", trigger: "blur"},
        ]
      },
      rowData: {},
    }
