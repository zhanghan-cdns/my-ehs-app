    ...
    >
      <template #content>
        ...
        >
          ...
          <el-row>
            <el-col span="24">
              <el-form-item label="规程编号" prop="zdbh">
                <el-input
                  placeholder="规程编号"
                  clearable
                  v-model="form.zdbh"
          ...
          <el-row>
            <el-col span="24">
              <el-form-item label="规程摘要" prop="zy">
                <el-input
                  type="textarea"
                  :rows="12"
                  clearable
          ...
          <el-row>
            <el-col span="12">
              <el-form-item label="编辑部门" prop="dlb">
                <el-select
                  clearable
                  placeholder="编辑部门"
                  v-model="form.dlb"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        zdmc: [{ required: true, message: "请输入规程名称", trigger: "blur" }],
      },
      row: {},
    };
  },
  ...
  methods: {
    ...
    open(row, type) {
      this.openEdit = true;
      this.title = "新增安全操作规程信息";
      if (row) {
        this.title = "编辑安全操作规程信息";
        this.row = row;
        this.getDetail(row.id);
      }

      if (type === "xiuding") {
        this.title = "修订安全操作规程信息";
      }
    },
    // 关闭
    close() {
