      ...
      <template #content>
        ...
        >
          <el-tab-pane name="rules">
            <span slot="label"
              ><i class="icon-jichuxinxi1 tab-icon"></i>规程信息</span
            >
            <rules-info ref="institutionalInfoRef"></rules-info>
          </el-tab-pane>
          <el-tab-pane name="approval">
            <span slot="label"
              ><i class="icon-jiancha tab-icon"></i>审批信息</span
            >
            <approval-form ref="approvalFormRef"></approval-form>
          </el-tab-pane>
        </el-tabs>
      </template>
    </basic-dialog>
...
import approvalForm from "@/views/institutionalized/lawsRegulations/lawIdentify/components/approvalForm.vue";
