    ...
    >
      <template #content>
        ...
        >
          ...
          <el-row>
            <el-col span="12">
              <el-form-item label="类别" prop="dlb">
                <el-select
                  clearable
                  placeholder="类别"
                  v-model="form.dlb"
            ...
            <el-col span="12">
              <el-form-item label="性质" prop="dlb">
                <el-select
                  clearable
                  placeholder="性质"
                  v-model="form.dlb"
          ...
          <el-row>
            <el-col span="24">
              <el-form-item label="发送部门" prop="fsbm">
                <el-select
                  clearable
                  placeholder="发送部门"
                  v-model="form.fsbm"
          ...
          <el-row>
            <el-col span="24">
              <el-form-item label="文件内容" prop="zy">
                <el-input
                  type="textarea"
                  :rows="10"
                  clearable
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        wjbh: [{ required: true, message: "请输入文件编号", trigger: "blur" }],
        wjmc: [{ required: true, message: "请输入文件名称", trigger: "blur" }],
        fsbm: [
          { required: true, message: "请选择发送部门", trigger: "change" },
        ],
      },
      row: {},
    };
