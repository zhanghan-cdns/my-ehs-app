        ...
        <div class="header">
          <div>
            <el-input
              ...
              placeholder="请输入储备库名称"
              clearable
              v-model="query.reserveBankName"
            ></el-input>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          field: "reserveBankName",
          title: "储备库名称",
          align: "center",
        },
        {
          field: "reserveBankAddress",
          title: "储备库地址",
          align: "center",
        },
        {
  ...
  methods: {
    ...
    async getTableData() {
      ...
      const res = await reserveBankPageAPI(params);
      if (res.code !== 200) {
    ...
    deleteTableData() {
      this.$confirm("你确定要删除此条记录吗?", "提示", {
        ...
        reserveBankDeleteAPI({ ids: this.ids.join(",") }).then((res) => {
          if (res && res.code === 200) {
            this.getTableData();
