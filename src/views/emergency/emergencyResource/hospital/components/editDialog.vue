          ...
          <div class="content_box">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item
                  label="主要负责人电话"
                  prop="mainResponsiblePersonNumber"
                >
                  <el-input
                    :style="`width:${width}`"
                    :size="size"
                    clearable
                    v-model="form.mainResponsiblePersonNumber"
                  ></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="医院专长" prop="expertise">
                  <el-input
                    :style="`width:${width}`"
                    :size="size"
                    clearable
              ...
              <el-col :span="12">
                <el-form-item label="病床数量" prop="bedNumber">
                  <el-input
                    :style="`width:${width}`"
                    :size="size"
                    clearable
...
export default {
  ...
  created() {
    this.getDicMap("hospitalLevel", "hospitalLevelList"); // 获取场所类型列表
  },
  methods: {
    close() {
      this.form = {};
        ...
        this.$refs.ruleForm.validate(async (valid) => {
          if (valid) {
            if (this.rowData) {
              ...
              const res = await hospitalUpdateAPI(params);
              if (res.code !== 200) {
              ...
              let params = { ...this.form };
              const res = await hospitalCreateAPI(params);
              if (res.code !== 200) {
