...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          field: "organizeResponsiblePerson",
          title: "组织负责人",
          align: "center",
        },
        {
          field: "responsiblePersonNumber",
          title: "负责人联系电话",
          align: "center",
        },
        {
          field: "organizeContactPerson",
          title: "组织联系人",
          align: "center",
        },
        {
          field: "organizeContactPersonNumber",
          title: "组织联系人电话",
          align: "center",
        },
        {
  ...
  methods: {
    ...
    async getTableData() {
      ...
      const res = await organizeDutyPageAPI(params);
      if (res.code !== 200) {
    ...
    deleteTableData() {
      this.$confirm("你确定要删除此条记录吗?", "提示", {
        ...
        organizeDutyDeleteAPI({ ids: this.ids.join(",") }).then((res) => {
          if (res && res.code === 200) {
            this.getTableData();
