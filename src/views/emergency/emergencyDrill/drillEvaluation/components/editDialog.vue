        ...
        <div class="recordsForm">
          ...
          >
            ...
            <el-form-item label="演练名称" prop="name">
              <el-select style="width: 100%" v-model="ruleForm.name">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  prop="num"
                >
                  <el-select style="width: 100%" v-model="ruleForm.num">
                    <el-option value="1">1</el-option>
                  </el-select>
                </el-form-item>
              </el-col>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        date: [{ required: true, message: "此项为必选项", trigger: "blur" }],
        drill: [{ required: true, message: "此项为必选项", trigger: "blur" }],
        main: [{ required: true, message: "此项为必选项", trigger: "blur" }],
        other: [{ required: true, message: "此项为必选项", trigger: "blur" }],
      },
      rectification: "1",
      Evaluationstate: "1",
    };
