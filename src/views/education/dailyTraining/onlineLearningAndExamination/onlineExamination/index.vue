              ...
              <div class="exm_info">
                <div>
                  <span style="color: #595959; font-size: 12px"
                    >考试成绩：</span
                  >
                  <!-- <span style="font-size: 14px; color: #597ef7">{{item.}}</span> -->
                </div>
                <div>
                  <span style="color: #595959; font-size: 12px"
                    >考试状态：</span
                  >
                  <span style="font-size: 14px" v-if="item.examState === '合格'"
                    >已通过</span
                  >
                  <span
                    style="font-size: 14px; color: #ff4d4f"
                    v-if="item.examState === '不合格'"
                    >未通过</span
                  >
                </div>
                <div>
...
import {
  ...
  finishedLearnAPI,
  expiredLearnAPI,
} from "@/api/education/dailyTraining/onlineLearningAndExamination/onlineExamination";
