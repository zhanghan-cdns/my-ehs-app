<template>
  <div class="courseManagement">
      ...
      <template #right>
        <div class="role_operation_box">
          ...
          <header-button @headerButtonClick="headerButtonMethods">
            <div class="btn" @click="openRewardsDialog">
              <img src="@/assets/images/education/jp.png" alt="" class="jp" />
              <span>奖惩</span>
            </div>
          </header-button>
        </div>
    ...
    ></edit-dialog>
    <rewards-dialog
      ref="rewardsDialogRef"
      @refresh="getList()"
      :rowData="choseRow"
    ></rewards-dialog>
    <online-dialog ref="onlineDialogRef"> </online-dialog>
  </div>
</template>
<script>
...
export default {
  components: { editDialog, rewardsDialog, onlineDialog },
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, { row, column, $index }) => {
            if (1) {
              return <div class="orange cell_btn" on-click={()=>{
                this.openOffline()
              }}>线下</div>;
            } else {
              return <div class="blue cell_btn">线上</div>;
            }
          },
        },
        {
