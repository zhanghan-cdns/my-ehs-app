<template>
  <div class="coursewareManagement">
    <list-container>
    ...
    <edit-dialog
      ref="editDialogRef"
      :dict="{
        educationSetWarelibraryFiletype,
        educationSetWarelibraryCategory,
      }"
      @refresh="getList()"
    ></edit-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    download(data) {
      ...
      let files = this.downLoadUrl + data.courseWare[0].url;
      console.log(data, this.downLoadUrl);
