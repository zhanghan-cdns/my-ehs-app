    ...
    <template #content>
      <div class="wrap">
        <div class="item">
          ...
          <myCharts id="passRate-id" :option="passRateOption" ref="passRateRef"></myCharts>
        </div>
        <div class="item">
          <div class="title">三级安全教育培训方式</div>
          <myCharts id="modee-id" :option="modeOption" ref="modeRef"></myCharts>
        </div>
        <div class="item">
          <div class="title">三级安全教育培训率</div>
          <myCharts id="training-rate-id" :option="trainingRateOption" ref="trainingRateRef"></myCharts>
        </div>
      </div>
    </template>
  </basic-dialog>
...
<script>
import {statisticsAPI} from "@/api/education/threeLevel/trainingRecords";
export default {
  data() {
    return {
      openFlag: false,
