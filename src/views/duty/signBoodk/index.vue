      ...
      <template #right>
        <div class="role_operation_box">
          <div>
            ...
            ></el-input>
            <el-select placeholder="请选择年度" v-model="query.checkRate">
              <el-option></el-option>
            </el-select>
            <!-- <el-select
              clearable
...
import editDialog from "@views/duty/signBoodk/components/editDialog.vue";
import viewDialog from "@views/duty/signBoodk/components/viewDialog.vue";
