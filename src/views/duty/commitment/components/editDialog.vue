      ...
      <template #content>
        ...
        >
          <el-row>
            ...
            <el-col span="12">
              <el-form-item label="岗位" prop="year">
                <el-select
                  placeholder="岗位"
                  clearable
                  v-model="form.year"
          ...
          <el-row>
            <el-col span="12">
              <el-form-item label="标题" prop="targetName">
                <el-input
                  placeholder="标题"
            ...
            <el-row>
            <el-col>
              <el-form-item label="内容" prop="editorValue">
                  <basic-editor ref="tinymceEditorRef" :value='form.editorValue' @getEditorValue="getEditorValue" style="width: 98.5%"></basic-editor>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
