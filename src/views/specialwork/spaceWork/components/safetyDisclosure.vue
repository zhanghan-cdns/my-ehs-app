<template>
  <div>
    ...
    >
      <el-row>
        <el-col span="24">
          <el-form-item label="气体监测分析人" prop="gasMonitoringAnalysts">
            <el-input
              placeholder="请输入气体监测分析人"
              clearable
              v-model="form.gasMonitoringAnalysts"
              :style="`width:${width2}`"
            ></el-input>
            <button-select @click="selectGasMonitoringAnalysts">选择</button-select>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col span="24">
          <el-form-item label="第三方监护人" prop="thirdPartyGuardian">
            <el-input
              placeholder="请输入第三方监护人"
              clearable
              v-model="form.thirdPartyGuardian"
              :style="`width:${width}`"
            ></el-input>
          </el-form-item>
        </el-col>
