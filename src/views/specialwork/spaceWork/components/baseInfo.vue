  ...
  <div>
    ...
    >
      ...
      <el-row>
        ...
        <el-col span="12">
          <el-form-item label="代办人" prop="applicant">
            <el-input
              placeholder="请选择代办人"
              clearable
              v-model="form.applicant"
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="受限空间所属单位" prop="workCertType">
            <el-input
              placeholder="请输入受限空间所属单位"
              clearable
        ...
        <el-col span="12">
          <el-form-item label="受限空间名称" prop="restrictedSpaceName">
            <el-input
              placeholder="请输入受限空间名称"
              clearable
              v-model="form.restrictedSpaceName"
              :style="`width:${width}`"
            ></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="受限空间内原有介质名称" prop="workCertName">
            <el-input
