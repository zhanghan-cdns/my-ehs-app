<template>
  <div>
    ...
    >
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="是否已实施" prop="isPalnned">
            <el-radio-group v-model="form.isPalnned">
              <el-radio :label="0">已实施</el-radio>
              <el-radio :label="1">未实施</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
        <el-col span="12">
          <el-form-item label="施工项目" prop="isFireMonitor">
            <el-input
              placeholder="请输入施工项目"
              clearable
              v-model="form.applicant"
      ...
      <el-row>
         <el-col span="12">
          <el-form-item label="吊装工具名称" prop="isFireMonitor">
            <el-input
        ...
        <el-col span="12">
          <el-form-item label="起吊重物质量（t）" prop="operateLocation">
            <el-input
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="吊装作业等级" prop="workCertType">
            <el-select
              placeholder="请选择吊装作业等级"
              clearable
      ...
      <el-row>
        <el-col span="24">
          <el-form-item label="吊物内容" prop="jobContent">
            <el-input
              type="textarea"
              :rows="6"
              clearable
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="吊装作业人" prop="chargeHotWork">
            <el-input
              placeholder="请选择吊装作业人"
              clearable
        ...
        <el-col span="12">
          <el-form-item label="申请人" prop="chargeHotWork">
            <el-input
              placeholder="请选择申请人"
              clearable
              v-model="form.chargeHotWork"
        ...
        <el-row>
        <el-col span="12">
          <el-form-item label="司索人" prop="chargeHotWork">
            <el-input
              placeholder="请选择司索人"
              clearable
              v-model="form.chargeHotWork"
        ...
        <el-col span="12">
          <el-form-item label="指挥人员" prop="chargeHotWork">
            <el-input
              placeholder="请选择指挥人员"
              clearable
              v-model="form.chargeHotWork"
