  ...
  <div>
    ...
    >
      ...
      <el-row>
        ...
        <el-col span="12">
          <el-form-item
            label="*是否涉及运行的生产装置、罐区、和具有火灾爆炸危险场所"
            prop="isInvolved"
          >
      ...
      <el-row>
        ...
        <el-col span="12">
          <el-form-item label="是否已实施" prop="isFireMonitor">
      ...
      <el-row>
        ...
        <el-col span="12">
          <el-form-item label="电源接入点及许可用电功率" prop="operateLocation">
            <el-input
          ...
          <!-- <el-form-item label="动火作业级别" prop="workCertType">
            <el-select
              placeholder="请选择动火作业级别"
              clearable
              v-model="form.workCertType"
              :style="`width:${width}`"
              :size="size"
            >
              <el-option
                v-for="item in dictConfig.workCertType"
                :key="item.id"
                :value="item.dictValue"
                :label="item.dictValueName"
              ></el-option>
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="工作电压" prop="chargeHotWork">
            <el-input
              placeholder="请选择工作电压"
              clearable
        ...
        <el-col span="12">
          <el-form-item label="用电设备名称及额定功率" prop="fireStarters">
            <el-input
              placeholder="请选择用电设备名称及额定功率"
              clearable
              v-model="form.fireStarters"
              :style="`width:${width}`"
              :size="size"
            ></el-input>
          </el-form-item>
      ...
      <!-- <el-row>
        <el-col span="24">
          <el-form-item label="动火方式" prop="fireType">
            <el-checkbox-group v-model="form.fireType">
              <el-checkbox
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="作业负责人" prop="applicant">
            <el-input
        ...
        <el-col span="12">
          <el-form-item label="作业负责人电工证号" prop="jobContent">
            <el-input
              clearable
              v-model="form.jobContent"
              :style="`width:${width}`"
              placeholder="请输入作业负责人电工证号"
              :size="size"
            ></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="用电人" prop="chargeHotWork">
            <el-input
              placeholder="请选择用电人"
              clearable
              v-model="form.chargeHotWork"
        ...
        <el-col span="12">
          <el-form-item label="作业人员" prop="fireStarters">
            <el-input
              placeholder="请选择作业人员"
              clearable
              v-model="form.fireStarters"
      ...
      <el-row>
        <el-col span="24">
          <el-form-item label="临时用电原因" prop="jobContent">
            <el-input
              type="textarea"
              :rows="6"
              clearable
