<template>
  <div class="common-box">
    <div class="common-title">部门人员在线率</div>
...
.common-box {
  ...
  .common-title {
    ...
    line-height: 42px;
    padding-left: 32px;
    background: url("/img/rydw/left-title.png") no-repeat;
  ...
  .common-title::before {
    ...
    width: 15px;
    height: 15px;
    background: url("/img/rydw/circle.png") no-repeat;
